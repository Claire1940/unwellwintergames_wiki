...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Unwell Winter Games",
    description: "Read the Terms of Service for Unwell Winter Games. Learn about user responsibilities, content usage guidelines, and legal terms for using our YouTube reality show resource platform.",
    keywords: [
      'terms of service',
      "Unwell Winter Games terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Unwell Winter Games",
      description: "Terms and conditions for using Unwell Winter Games.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Unwell Winter Games
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Unwell Winter Games ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Unwell Winter Games.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Unwell Winter Games is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the YouTube reality show "Unwell Winter Games". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Unwell Winter Games is NOT affiliated with, endorsed by, or associated with
              Alex Cooper, Unwell Network, or the official creators of Unwell Winter Games. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Unwell Winter Games and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Alex Cooper, Unwell Network, and/or the creators of Unwell Winter Games. We use such
            ...
            <ul>
              ...
              <li><strong>Episode Availability:</strong> Episode availability and show updates may change without notice. We are not responsible for content changes or access issues.</li>
            </ul>
            <p>
            ...
            <p>
              The Website may contain links to third-party websites, including YouTube, Reddit, Instagram, social media platforms,
            ...
            <p>
              ...
              you and Unwell Winter Games regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@unwellwintergames.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@unwellwintergames.wiki</a>
            </p>
            <p>
