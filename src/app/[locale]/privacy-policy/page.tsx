...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Unwell Winter Games',
    description: 'Unwell Winter Games Privacy Policy. Learn how we collect, use, and protect your data when you use our YouTube reality show resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Unwell Winter Games privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Unwell Winter Games ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <p>
              Our website may contain links to external websites, including YouTube, Reddit, Instagram, and other social media platforms.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Unwell Winter Games is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with the creators or developers of Unwell Winter Games. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@unwellwintergames.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@unwellwintergames.wiki</a>
            </p>
            <p>
