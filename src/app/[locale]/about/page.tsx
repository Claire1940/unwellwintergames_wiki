...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'About Unwell Winter Games - Your Ultimate Steam Game Resource',
    description: 'Learn about Unwell Winter Games, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Unwell Winter Games YouTube reality show.',
    keywords: [
      'about Unwell Winter Games',
      'Unwell Winter Games community',
      'YouTube reality show wiki',
      'entertainment resource hub',
      'Unwell Winter Games team',
    ],
    robots: {
      index: false,
      follow: true,
    ...
    openGraph: {
      ...
      siteName: 'Unwell Winter Games',
      title: 'About Unwell Winter Games',
      description: 'Learn about our mission to provide the best Unwell Winter Games entertainment resources and guides.',
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: 'Unwell Winter Games',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Unwell Winter Games',
      description: 'Learn about our mission to provide the best Unwell Winter Games entertainment resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Unwell Winter Games
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Unwell Winter Games</h2>
            <p>
              Unwell Winter Games is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the YouTube reality show "Unwell Winter Games". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Unwell Winter Games is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Unwell Winter Games players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Unwell Winter Games as the <strong>go-to destination</strong> for every Unwell Winter Games player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Unwell Winter Games is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Unwell Winter Games is maintained by a dedicated team of passionate gamers and developers who love
              Unwell Winter Games as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Unwell Winter Games mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Unwell Winter Games is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Unwell Winter Games or any official entities.
            </p>
            <p>
            ...
            <p>
              Unwell Winter Games is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@unwellwintergames.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@unwellwintergames.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@unwellwintergames.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@unwellwintergames.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@unwellwintergames.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@unwellwintergames.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@unwellwintergames.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@unwellwintergames.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Unwell Winter Games news.
