...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Unwell Winter Games',
    description: 'Copyright and intellectual property information for Unwell Winter Games. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Unwell Winter Games copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Unwell Winter Games',
      description: 'Copyright and intellectual property information for Unwell Winter Games.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Unwell Winter Games. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Unwell Winter Games and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Unwell Winter Games is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>YouTube</strong> - Owner of the YouTube platform</li>
              <li><strong>Unwell Winter Games Developers</strong> - Creators of the Unwell Winter Games game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>UNWELL</strong> - Trademark of Alex Cooper / Unwell Network</li>
              <li><strong>Unwell Winter Games</strong> - Trademark of the game developers</li>
              <li><strong>Unwell Winter Games</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Unwell Winter Games.
            </p>
            ...
            <p>
              ...
              Unwell Winter Games<br />
              Email: <a href="mailto:dmca@unwellwintergames.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@unwellwintergames.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Unwell Winter Games"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Unwell Winter Games (unwellwintergames.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@unwellwintergames.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@unwellwintergames.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@unwellwintergames.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@unwellwintergames.wiki</a>
            </p>
            <p>
